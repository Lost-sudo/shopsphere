...
1. Overview
This document describes the technology stack used to build a scalable, secure, and production-ready e-commerce application.
The stack emphasizes type safety, performance, developer experience, and modern best practices, using TypeScript end-to-end.
...
Why PostgreSQL
    ...
    • Ideal for orders, payments, inventory
Why Prisma
...
Auth Strategy
    ...
    • Stateless access, Redis-backed sessions
